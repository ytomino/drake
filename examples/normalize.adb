...
procedure normalize is
	use type Ada.Strings.Normalization.Class;
	subtype C is Character;
	subtype WWC is Wide_Wide_Character;
	subtype WWS is Wide_Wide_String;
begin
	-- combining class
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'First) = 0);
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'Val (16#0308#)) = 230);
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'Val (16#0323#)) = 220);
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'Val (16#3099#)) = 8);
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'Val (16#e0100#)) = 0); -- VARIATION SELECTOR
	pragma Assert (Ada.Strings.Normalization.Combining_Class (WWC'Last) = 0);
	declare
		...
		Last : Natural;
	begin
		Ada.Strings.Normalization.Get_Combined (S, Last);
		pragma Assert (Last = 3);
		Ada.Strings.Normalization.Get_Combined (S (Last + 1 .. S'Last), Last);
	...
	pragma Assert (Ada.Strings.Normalization.Decompose ((1 => WWC'Val (16#AC00#))) = WWC'Val (16#1100#) & WWC'Val (16#1161#)); -- hangle LV
	pragma Assert (Ada.Strings.Normalization.Decompose ((1 => WWC'Val (16#AC01#))) = WWC'Val (16#1100#) & WWC'Val (16#1161#) & WWC'Val (16#11A8#)); -- hangle LVT
	...
	pragma Assert (Ada.Strings.Normalization.Compose (WWC'Val (16#1100#) & WWC'Val (16#1161#)) = (1 => WWC'Val (16#AC00#))); -- hangle LV
	pragma Assert (Ada.Strings.Normalization.Compose (WWC'Val (16#1100#) & WWC'Val (16#1161#) & WWC'Val (16#11A8#)) = (1 => WWC'Val (16#AC01#))); -- hangle LVT
