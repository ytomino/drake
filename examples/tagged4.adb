...
procedure tagged4 is
	...
	package A is
		type Aggregated_Object is new I.Intf with null record;
	...
	package C is
		type Container is tagged limited record
			Field : aliased A.Aggregated_Object;
		end record;
	...
	package body C is
		...
		package Impl is new Ada.Tags.Delegating.Implements (Container, I.Intf, Get);
	end C;
	Obj : aliased C.Container;
