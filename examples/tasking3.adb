...
procedure tasking3 is
	...
	Ts : array (1 .. Count) of System.Tasking.Tasks.Task_Id;
	Aborted : Boolean;
begin
	for I in Ts'Range loop
		System.Tasking.Tasks.Create (Ts (I), System.Null_Address, Process'Access);
		Attr.Set_Value (I, T => Cast (Ts (I)));
	end loop;
	for I in Ts'Range loop
		System.Tasking.Tasks.Wait (Ts (I), Aborted => Aborted);
	end loop;
