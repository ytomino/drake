...
begin
	...
	begin
		System.Form_Parameters.Form_Parameter (Form_1, "abc", First, Last);
		pragma Assert (Form_1 (First .. Last) = "def");
		System.Form_Parameters.Form_Parameter (Form_1, "a", First, Last);
		pragma Assert (Form_1 (First .. Last) = "" and then First = 1);
		System.Form_Parameters.Form_Parameter (Form_1, "c", First, Last);
		pragma Assert (Form_1 (First .. Last) = "" and then First = 1);
		System.Form_Parameters.Form_Parameter (Form_1, "def", First, Last);
		pragma Assert (Form_1 (First .. Last) = "" and then First = 1);
		System.Form_Parameters.Form_Parameter (Form_2, "abc", First, Last);
		pragma Assert (Form_2 (First .. Last) = "def");
		System.Form_Parameters.Form_Parameter (Form_2, "ghi", First, Last);
		pragma Assert (Form_2 (First .. Last) = "" and then First > 1);
		System.Form_Parameters.Form_Parameter (Form_3, "ghi", First, Last);
		pragma Assert (Form_3 (First .. Last) = "" and then First > 1);
		System.Form_Parameters.Form_Parameter (Form_4, "ghi", First, Last);
		pragma Assert (Form_4 (First .. Last) = "" and then First > 1);
		System.Form_Parameters.Form_Parameter (Form_4, "abc", First, Last);
