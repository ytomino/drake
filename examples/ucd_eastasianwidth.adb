...
begin
	...
	Put_Line ("   pragma Pack (Table_32_Item_Type);");
	Put_Line ("   pragma Compile_Time_Error (Table_32_Item_Type'Size /= 64, ""packed?"");");
	New_Line;
	...
	Put_Line ("   pragma Pack (Table_32_Type);");
	Put_Line ("   pragma Compile_Time_Error (Table_32_Type'Component_Size /= 64, ""packed?"");");
	New_Line;
		...
		while Has_Element (I) loop
			...
			begin
				...
				Put (
					...
					Width => 1);
				Put (", ");
				Put (EAW_Property_Names.Instance.Constant_Reference (EAW'Access).Element.all);
				Put (")");
