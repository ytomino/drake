...
generic
   ...
   with package Base_Holders is
      new Counted_Access_Holders (Base_Name, Free => <>);
   ...
   with package Derived_Holders is
      new Counted_Access_Holders (Derived_Name, Free => <>);
package Ada.Containers.Counted_Access_Holders_Derivational_Conversions is
