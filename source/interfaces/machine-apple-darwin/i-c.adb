...
package body Interfaces.C is
   ...
   package char_Func is
      new Functions (
         ...
         char_array,
         char_Lengths.Length,
         char_Conv.To_Non_Nul_Terminated,
         char_Conv.From_Non_Nul_Terminated,
         Expanding_To_C => 1,
         Expanding_To_Ada => 1);
   ...
   package wchar_Wide_Func is
      new Functions (
         ...
         From_Non_Nul_Terminated,
         Expanding_To_C => 1, -- Expanding_From_16_To_32
         Expanding_To_Ada => 2); -- Expanding_From_32_To_16

   package wchar_Wide_Wide_Conv is
      new Simple_Conversions (
         Wide_Wide_Character,
         Wide_Wide_String,
         wchar_t,
   ...
   package wchar_Wide_Wide_Func is
      new Functions (
         ...
         wchar_array,
         wchar_Lengths.Length,
         wchar_Wide_Wide_Conv.To_Non_Nul_Terminated,
         wchar_Wide_Wide_Conv.From_Non_Nul_Terminated,
         Expanding_To_C => 1,
         Expanding_To_Ada => 1);
   ...
   begin
      if Append_Nul then
         ...
         wchar_Wide_Wide_Conv.To_Non_Nul_Terminated (Item, Target, Count,
            Substitute => wide_nul);
      end if;
   end To_wchar_array;
   ...
   begin
      if Trim_Nul then
         ...
         wchar_Wide_Wide_Conv.From_Non_Nul_Terminated (Item, Target, Count,
            Substitute => Wide_Wide_Character'Val (0));
      end if;
   end To_Wide_Wide_String;
