...
--    Trim_Nul : Boolean := True);
   ...
   package wchar_String_Slicing
      renames Ada.References.Wide_Wide_String.Slicing;
...
--  pragma Pack (wchar_array); -- [gcc-4.5] cannot pack aliased components
...
--  pragma Pack (char16_array); -- [gcc-4.5] cannot pack aliased components
...
--  pragma Pack (char32_array); -- [gcc-4.5] cannot pack aliased components
