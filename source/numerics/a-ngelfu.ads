...
--  function Cos (X : Float_Type'Base) return Float_Type'Base;
   ...
   pragma Inline (Cos);
   function Tan is new Float.Elementary_Functions.Tan (Float_Type'Base);
   function Tan (X, Cycle : Float_Type'Base) return Float_Type'Base;
   pragma Inline (Tan);
   function Cot (X : Float_Type'Base) return Float_Type'Base;
   function Cot (X, Cycle : Float_Type'Base) return Float_Type'Base;

   function Arcsin is new Float.Elementary_Functions.Arcsin (Float_Type'Base);
   function Arcsin (X, Cycle : Float_Type'Base) return Float_Type'Base;
   pragma Inline (Arcsin);
   function Arccos is new Float.Elementary_Functions.Arccos (Float_Type'Base);
...
--  function Cosh (X : Float_Type'Base) return Float_Type'Base;
   ...
   function Tanh is new Float.Elementary_Functions.Tanh (Float_Type'Base);
   function Coth (X : Float_Type'Base) return Float_Type'Base;
   function Arcsinh is
      new Float.Elementary_Functions.Arcsinh (Float_Type'Base);
   function Arccosh is
      new Float.Elementary_Functions.Arccosh (Float_Type'Base);
   function Arctanh is
      new Float.Elementary_Functions.Arctanh (Float_Type'Base);
