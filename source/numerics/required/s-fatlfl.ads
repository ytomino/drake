...
package System.Fat_Lflt is
   ...
   package Attr_Long_Float is
      ...
      function Adjacent (X, Towards : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_nextafter";

      --  required for Long_Float'Ceiling by compiler (s-fatgen.ads)
      function Ceiling (X : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_ceil";
      ...
      function Copy_Sign (X, Y : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_copysign";
      ...
      function Floor (X : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_floor";
      ...
      function Machine_Rounding (X : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_nearbyint";
      ...
      function Truncation (X : Long_Float) return Long_Float
         with Import,
            Convention => Intrinsic, External_Name => "__builtin_trunc";
      ...
      type S is new String (1 .. Long_Float'Size / Character'Size);
