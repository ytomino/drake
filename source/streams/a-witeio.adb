...
package body Ada.Wide_Text_IO is
   ...
   function Get_Line (File : File_Type) return Wide_String is
      Line_Buffer : Wide_String_Access := new Wide_String (1 .. 256);
      First : Positive := 1;
   begin
      loop
         declare
         ...
         begin
            ...
            if Last < Line_Buffer'Last then
               return Result : Wide_String := Line_Buffer (1 .. Last) do
               ...
               declare
                  New_Buffer : constant Wide_String_Access := new Wide_String
                     (1 .. Line_Buffer'Last * 2);
               begin
