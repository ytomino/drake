...
--  function Blank_When_Zero (Pic : Picture) return Boolean;
   ...
   generic
      ...
      Default_Currency : Wide_Wide_String := Editing.Default_Currency;
      Default_Fill : Wide_Wide_Character := Editing.Default_Fill;
      Default_Separator : Wide_Wide_Character := Editing.Default_Separator;
      Default_Radix_Mark : Wide_Wide_Character := Editing.Default_Radix_Mark;
